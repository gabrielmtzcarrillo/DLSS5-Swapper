...
test('DX10 relay requires Feeder 0.13.1 or newer', () => {
  ...
  assert.equal(feederReleases.supportsDx10('1.16.0-beta.6'), true);
});

test('Feeder 1.16.0-beta.6 is selectable while 0.15.1 stays the default', () => {
  ...
  const beta = feederReleases.release('1.16.0-beta.6');
  assert.equal(beta.version, '1.16.0-beta.6');
