...
contextBridge.exposeInMainWorld('lab', {
  ...
  install: (dir, exePath, route, api, addon, multiFrameGeneration, additionalEffects, dgVoodooVersion, mfgVersion, dlssSource) => ipcRenderer.invoke('install', dir, exePath, route, api, addon, multiFrameGeneration, additionalEffects, dgVoodooVersion, mfgVersion, dlssSource),
