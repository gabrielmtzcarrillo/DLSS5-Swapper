...
contextBridge.exposeInMainWorld('lab', {
  ...
  install: (dir, exePath, route, api, addon, multiFrameGeneration, additionalEffects, dgVoodooVersion) => ipcRenderer.invoke('install', dir, exePath, route, api, addon, multiFrameGeneration, additionalEffects, dgVoodooVersion),
