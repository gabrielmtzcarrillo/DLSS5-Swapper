...
contextBridge.exposeInMainWorld('lab', {
  ...
  install: (dir, exePath, route, api, addon, multiFrameGeneration, additionalEffects) => ipcRenderer.invoke('install', dir, exePath, route, api, addon, multiFrameGeneration, additionalEffects),
